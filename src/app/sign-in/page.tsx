    ...
    const handleSendOtp = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast({
                ...
                description: "We couldn't reach the auth server. This is usually due to a configuration issue (400) or rate limits."
            });
        } finally {
            setIsLoading(false);
        }
                                    ...
                                    >
                                        ...
                                        <div className="space-y-4">
                                            <button
                                                ...
                                                disabled={isLoading}
                                                className="w-full flex items-center justify-center gap-4 bg-brand-ink text-brand-cream font-bold text-lg py-5 px-8 rounded-full hover:bg-brand-moss transition-all duration-500 disabled:opacity-50 disabled:cursor-not-allowed shadow-2xl shadow-brand-ink/20 group relative overflow-hidden"
                                            >
                                                ...
                                                {isLoading && !showEmailForm ? (
                                                    ...
                                                    <>
                                                        ...
                                                        <span className="font-bold lowercase">continue with google</span>
                                                    </>
                                                )}
                                            </button>
                                            <p className="text-center text-[10px] text-brand-sage font-bold tracking-widest uppercase opacity-40">highly recommended</p>
                                        </div>
